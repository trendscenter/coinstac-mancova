...
% FORMAT str = icatb_spm_file(str,option)
...
%
% FORMAT str = icatb_spm_file(str,opt_key,opt_val,...)
% str        - character array, or cell array of strings
...
% Examples:
%
% icatb_spm_file('C:\data\myimage.nii', 'prefix','rp_', 'ext','.txt')
% returns 'C:\data\rp_myimage.txt' on a Windows platform
%
% icatb_spm_file({'/home/karl/software/spm8/spm.m'},'path','/home/karl/spm12')
% returns {'/home/karl/spm12/spm.m'}
%
% icatb_spm_file('/home/karl/software/spm12/spm.m','filename')
% returns 'spm.m', and
% icatb_spm_file('/home/karl/software/spm12/spm.m','basename')
% returns 'spm'
%
% icatb_spm_file('SPM.mat','fpath')
% returns '/home/karl/data/stats' (i.e. pwd), while
% icatb_spm_file('SPM.mat','path')
% returns '', and
% icatb_spm_file('SPM.mat','cpath')
% returns '/home/karl/data/stats/SPM.mat'
%__________________________________________________________________________
%
% See also: icatb_spm_fileparts, icatb_spm_select, icatb_spm_file_ext, icatb_spm_existfile
%__________________________________________________________________________
% Copyright (C) 2011-2014 Wellcome Trust Centre for Neuroimaging

% Guillaume Flandin
% $Id: icatb_spm_file.m 6346 2015-02-24 11:01:50Z volkmar $
